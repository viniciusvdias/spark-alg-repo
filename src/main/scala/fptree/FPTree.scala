...
case class FPTree(
  ...
  def powerSet = {
    def powerSetRec(node: Node, pSet: ListBuffer[(Stack[String],Int)]): ListBuffer[(Stack[String],Int)] = {
  ...
  def fpGrowth(
      itemSets: ListBuffer[(Stack[String],Int)] = ListBuffer()): ListBuffer[(Stack[String],Int)] = {
